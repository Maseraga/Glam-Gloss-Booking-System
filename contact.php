...
<head>
  ...
  <style>
    ...
    .navigation {
      ...
      text-align: center;
      margin-top: 40px;
      /* Add margin to the top to move the navigation down */
    }
    ...
    h2 {
      ...
      /* Make the animation slower (you can adjust this value) */
    ...
    .hidden-image {
      ...
      z-index: 999;
      /* Ensure the image pops up above other content */
    }
...
<body>
  ...
  <script>
    ...
    h2
    =
    document.querySelector('.animation-h2');
